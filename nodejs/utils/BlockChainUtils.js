...
function bcu() {
    var option = {
        ...
        params: {
            type: 1,
            chaincodeID: {
                name: cccfg.getChainCodeName("mycc")
            },
            ctorMsg: {
                args: [" "]
            },
    ...
    this.chaincode.invoke = function (args, cbfunc) {
        ...
        option.params.chaincodeID.name = 'ee5b24a1f17c356dd5f6e37307922e39ddba12e5d2e203ed93401d7d05eb0dd194fb9070549c5dc31eb63f4e654dbd5a1d86cbb30c48e3ab1812590cd0f78539';
    ...
    //     var cmd_sign = "CORE_CHAINCODE_ID_NAME=" + cccfg.getChainCodeName(name) + " CORE_PEER_ADDRESS=0.0.0.0:7051 " + __dirname + "/../chaincode/sycoin/sycoin \n";
    ...
    //     option.params.ctorMsg.function = func;
    //     option.params.ctorMsg.args = args;
    //     option.params.chaincodeID.name = cccfg.getChainCodeName("mycc")
    //     option.params.chaincodeID.path = "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02"
    //     option.id = 1;
    //     // logger.debug("option=" + JSON.stringify(option));
    //     client.post("chaincode", option, function (err, res, body) {
    //         cbfunc(err, res, body);
